...
class DependentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dependente" do
    assert_difference('Dependente.count') do
      post dependentes_url, params: { dependente: { cpf_func: @dependente.cpf_func, datanasc: @dependente.datanasc, nome: @dependente.nome, relacao: @dependente.relacao, sexo: @dependente.sexo } }
    end
  ...
  test "should update dependente" do
    patch dependente_url(@dependente), params: { dependente: { cpf_func: @dependente.cpf_func, datanasc: @dependente.datanasc, nome: @dependente.nome, relacao: @dependente.relacao, sexo: @dependente.sexo } }
