...
class MesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post mesas_url, params: { mesa: { codigo: @mesa.codigo, conta: @mesa.conta, horarioentrada: @mesa.horarioentrada, horariosaida: @mesa.horariosaida } }
    end
  ...
  test "should update mesa" do
    patch mesa_url(@mesa), params: { mesa: { codigo: @mesa.codigo, conta: @mesa.conta, horarioentrada: @mesa.horarioentrada, horariosaida: @mesa.horariosaida } }
